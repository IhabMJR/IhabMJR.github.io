    ...
    <div id="history">
      <div className="items-container">
        ...
        <p>
          ...
          <br />
          <br />
          Actuellement, je suis à la recherche d'un stage pour mettre en pratique mes compétences techniques et ma créativité dans des projets dans le domaine du web ou des jeux vidéos, dans le but d'améliorer mes compétences et de progresser dans ma carrière.
        </p>
      </div>
    </div>
  );
